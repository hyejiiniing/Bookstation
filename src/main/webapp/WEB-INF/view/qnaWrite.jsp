				...
				<div class="col-md-8 col-lg-9 p-b-80 order-md-2">
					<div class="p-r-45 p-r-0-lg">
						...
						<div class="con">
							...
							<form action="qnaWrite.do" method="post" onsubmit="return validateForm()">
								<table class="mp_table type01">
									...
									<tbody>
										<c:forEach var="member" items="${writeList }">
											<tr>
												<th class="normal">아이디</th>
												<td colspan="3" class="p10">
													<input type="hidden" name="member_id" value="${member.member_id }">${member.member_id }
												</td>
											</tr>
										</c:forEach>
										<tr>
