					...
					<div class="p-r-45 p-r-0-lg">
						...
						<div class="bookimg">
						  <div class="star_rating">
 						  ...
 						  <form id="reviewForm" action="updateSubmit.do" method="post">
 						  <c:forEach var="list2" items="${reviewlist2}">
						  		 <input type="hidden" name="review_id" value="${list2.review_id}">
							     <input type="hidden" name="member_id" value="test1">
							     <input type="hidden" name="isbn" value="${list2.isbn}">
							     <input type="hidden" name="review_date" value="${list2.review_date}">
							    <textarea class="star_box" name="review_content" >${list2.review_content }</textarea>
							     <div class="star_rating">
	                        	...
	                        	<input type="hidden" name="review_score" value="0">
							     ...
							     <input type="hidden" name="ordersPrint_id" value="${list2.ordersPrint_id}">
						  	</c:forEach>
						  	 	 <input type="submit" class="btn02" style="top:-45px; cursor: pointer;" value="리뷰 수정"/>
