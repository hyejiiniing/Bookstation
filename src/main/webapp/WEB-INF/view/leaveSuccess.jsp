...
<!--===============================================================================================-->
    ...
    <!-- top -->
        ...
        <div class="row d-flex justify-content-center align-items-center" style="height: 90vh;">
            <div>
                <span class="name">회원탈퇴</span>&nbsp;<span class="nim">되었습니다.</span><br>
                <span class="text">북스테이션을 이용해주셔서 감사합니다.</span><p></p>
                <a href="main.do" id="logingo" class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer">메인페이지 이동</a>
            </div>    
        </div>
